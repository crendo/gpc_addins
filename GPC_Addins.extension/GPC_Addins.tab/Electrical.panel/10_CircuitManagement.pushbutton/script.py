            ...
            try:
                ...
                for circuit in circuits:
                    ...
                    if c_name not in db_from_model:
                        ...
                        # Same name seen again -- only flag it when the cable config differs
                    ...
                    # (same circuit through multiple conduits) -- no action needed.
            except Exception:
                pass
...
def init_circuit_database(doc_obj):
    ...
    # --- Step 3: Merge model circuits that are missing from the JSON ---
    added_from_model = []
