# -*- coding: utf-8 -*-
"""Show all GPC Takeoff markers (Area and Lineal)."""
__title__ = 'Mostrar Marcadores'
...
def set_markers_visibility(visible):
    ...
    count = 0
    with revit.Transaction("Mostrar Marcadores" if visible else "Ocultar Marcadores"):
